...
class DialPadPropertype {
    ...
    let text1 :UIButton = {
        ...
        text.frame = CGRect(x: 55, y:250 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
    ...
    let text2 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 155, y:250 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text3 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 255, y:250 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text4 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 55, y:350 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text5 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 155, y:350 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text6 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 255, y:350 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text7 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 55, y:450 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text8 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 155, y:450 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text9 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 255, y:450 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
    ...
    let text10 :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 55, y:550 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
        text.backgroundColor = UIColor(red: 237/255, green: 237/255, blue: 237/255, alpha: 1.0)
    ...
    let text0 :UIButton = {
        let text = UIButton(type: .custom)
        //text.frame = CGRect(x: 155, y:550 , width: 70, height: 70)
        //text.layer.cornerRadius = 0.5 * text.bounds.size.width
        //text.clipsToBounds = true
    ...
    let text11 :UIButton = {
        let text = UIButton(type: .custom)
//        text.frame = CGRect(x: 255, y:550 , width: 70, height: 70)
//        text.layer.cornerRadius = 0.5 * text.bounds.size.width
//        text.clipsToBounds = true
        text.setTitle("#", for: .normal)
        text.backgroundColor = UIColor(red: 237/255, green: 237/255, blue: 237/255, alpha: 1.0)
    ...
    let call :UIButton = {
        let text = UIButton(type: .custom)
        text.frame = CGRect(x: 155, y:650 , width: 70, height: 70)
        text.layer.cornerRadius = 0.5 * text.bounds.size.width
        text.clipsToBounds = true
